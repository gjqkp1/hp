...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text="channel", url="https://t.me/GJK_E"
            ),
            InlineKeyboardButton(
                text="group", url="https://t.me/VVINL"
            )
        ],
        [
            InlineKeyboardButton(
                text="𝖥𝗈𝗋 ᥲ️ᖴY᥆ꪀᥲ️ . 💸 ˼ ", url="https://t.me/GJQKP"
            )
        ],
    ]
    return buttons
...
def stream_markup(_, videoid, chat_id):
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text="channel", url="https://t.me/VVINF"
            ),
            InlineKeyboardButton(
                text="group", url="https://t.me/VVINL"
            )
...
def telegram_markup(_, chat_id):
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text=_["PL_B_3"], url=f"https://t.me/MS1TBOT?startgroup=true",
            ),
        ],
    ]
    return buttons
