            ...
            [
                [
                    InlineKeyboardButton(
                        "‹ ᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ . 🐰 ›", url=f"https://t.me/GJK_U"),
                ],
            ]
        ),
    )
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("‹ اضف البوت مجموعتك ›", url=f"https://t.me/Ms1TBOT?startgroup=true"),
                ],[
                InlineKeyboardButton(
                        "‹ ᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ . 🐰 ›", url=f"https://t.me/GJk_U"), 
                ]
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""◉ 𝙽𝙰𝙼𝙴 : ❪ [𓏺 ժᥱ᥎ ꪀᥲ️ժᥱᖇ . 🕷 ˼](https://t.me/GJQKP)  ❫
◉ 𝚄𝚂𝙴𝚁 : ❪ @GJQKP ❫
◉ 𝙸𝙳   : ❪ 5900479364 ❫
◉ 𝙱𝙸𝙾  : ❪ انا كبير في عين نفسي. انما عينك انتا تع احطلك فيها قطره. @GJQKP ❫ """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("‹ ժᥱ᥎ ꪀᥲ️ժᥱᖇ ›", url=f"https://t.me/GJQKP"),
                ],[
                InlineKeyboardButton(
                        "‹ ᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ . 🐰 › ", url=f"https://t.me/GJK_U"), 
                ]
...
◉ 𝚄𝚂𝙴𝚁 : ❪ @GJQKP ❫
◉ 𝙸𝙳   : ❪ 5900479364 ❫
◉ 𝙱𝙸𝙾  : ❪ انا كبير في عين نفسي. انما عينك انتا تع احطلك فيها قطره. @GJK_U ❫ """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("‹ ժᥱ᥎ ꪀᥲ️ժᥱᖇ ›", url=f"https://t.me/GJQKP"),
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/37e224b04dfedf222f8d2.jpg",
        caption=f"""◉ 𝙽𝙰𝙼𝙴 : ❪ [𓏺 ժᥱ᥎ ꪀᥲ️ժᥱᖇ . 🕷 ˼](https://t.me/GJK_U)  ❫
◉ 𝚄𝚂𝙴𝚁 : ❪ @GJqkp ❫
◉ 𝙸𝙳   : ❪ 5900479364 ❫
◉ 𝙱𝙸𝙾  : ❪ انا كبير في عين نفسي. انما عينك انتا تع احطلك فيها قطره. @GJK_U ❫ """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("‹ ժᥱ᥎ ꪀᥲ️ժᥱᖇ ›", url=f"https://t.me/GJK_U"),
                ],[
                InlineKeyboardButton(
                        "‹ ᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ . 🐰 ›", url=f"https://t.me/GJQKP"), 
                ]
            ]
        ),
    )
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""╭──── • ◈ • ────╮
么 [َ ᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ](t.me/GJQKP)
么 [َժᥱ᥎ ꪀᥲ️ժᥱᖇ](t.me/GJK_U)
么 [َ ᥉υρρ᥆ᖇƚ ](t.me/VVINL)
╰──── • ◈ • ────╯
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼""",
        ...
        [
            [
                    InlineKeyboardButton(
                        "‹ ժᥱ᥎ ꪀᥲ️ժᥱᖇ . 🕷 › ", url=f"https://t.me/GJQKP"),
                ],[
                    InlineKeyboardButton(
                        "‹ ᥴ𝗁ᥲ️ꪀꪀᥱᥣ›", url=f"https://t.me/GJK_U"), 
                    InlineKeyboardButton(
                        "‹ ᥉υρρ᥆ᖇƚ›", url=f"https://t.me/VVINL"),
                ],[
                    InlineKeyboardButton(
                        "‹ اضف البوت لمجموعتك ›", url=f"https://t.me/Ms1TBOt?startgroup=true"),
            ]
        ]
         ),
     )
