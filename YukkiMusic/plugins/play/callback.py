...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/GJK_u) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/GJK_U) /AFYN \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/GJK_U)\n [ᖴ᥆ᖇ ᥲ️ᖇꪀ᥆ρ. 🐰](https://t.me/GJQKP)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/GJK_U) """,
...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="afyona"),
                ...
                [
                    InlineKeyboardButton(
                        "الجروب", url=f"https://t.me/VVINL"
                    ),
                    InlineKeyboardButton(
                        "القناة", url=f"https://t.me/VVINf"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "𝖥𝗈𝗋 ᥲ️ᖴY᥆ꪀᥲ️ . 💸", url="https://t.me/GJQKP"
                    )
                ],
            ]
        ),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/GJK_U) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/VVINL) \n ※[These Features AI Based](https://t.me/GJQKP)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="ww_2_2"),
                ...
                [                
                    ...
                    InlineKeyboardButton(" Donate", url=f"https://t.me/GJQKP"),
                ],
                [
                    InlineKeyboardButton(
                        "Group", url=f"https://t.me/VVINL"
                    ),
                    InlineKeyboardButton(
                        "Channel", url=f"https://t.me/VVINF"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع افيونا من هن : @GJQKP **
\n __ Developer by [𝖥𝗈𝗋 ᥲ️ᖴY᥆ꪀᥲ️ . 💸](https://t.me/GJQKP)""",
        reply_markup=InlineKeyboardMarkup(
...
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""<b> يمكنك التواصل معي \n عن طريق معرفي اول جروب التواصل بلاسفل..↑↓ \n\n [𝖥𝗈𝗋 ᥲ️ᖴY᥆ꪀᥲ️ . 💸](https://t.me/GJQKP)</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("القناة", url=f"https://t.me/VVINF"),
                    InlineKeyboardButton("الجروب", url=f"https://t.me/VVINL"),
                ],
                [
                    InlineKeyboardButton("البوت", url=f"https://t.me/MS1TBOT"),
                    InlineKeyboardButton("التواصل", url=f"https://t.me/GJQKP"),
                ],
                [InlineKeyboardButton("ᖴ᥆ᖇ. 🐉", url=f"https://t.me/GJQKP")],
            ]
        ),
    )
